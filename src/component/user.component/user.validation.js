...
module.exports = {
  userSignUp: () => {
    let validation = [
      ...
      body('password').not().isEmpty().withMessage(() => { return i18n.__('password is Required') }).isLength({min:8}),
      body('confirmPassword').not().isEmpty().withMessage(() => { return i18n.__('password is Required') }).isLength({min:8}),
